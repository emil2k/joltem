...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'project_project', 'is_private',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding M2M table for field invitee_set on 'Project'
        m2m_table_name = db.shorten_name(u'project_project_invitee_set')
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'project_project', 'is_private')

        # Removing M2M table for field invitee_set on 'Project'
        db.delete_table(db.shorten_name(u'project_project_invitee_set'))
