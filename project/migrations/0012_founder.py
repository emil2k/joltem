...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field founder_set on 'Project'
        m2m_table_name = db.shorten_name(u'project_project_founder_set')
    ...
    def backwards(self, orm):
        # Removing M2M table for field founder_set on 'Project'
        db.delete_table(db.shorten_name(u'project_project_founder_set'))
    ...
    models = {
        ...
        u'project.project': {
            ...
            'founder_set': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'founder_project_set'", 'symmetrical': 'False', 'to': u"orm['joltem.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'impact_shares': ('django.db.models.fields.BigIntegerField', [], {'default': '0'}),
            'invitee_set': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'invitee_project_set'", 'symmetrical': 'False', 'to': u"orm['joltem.User']"}),
