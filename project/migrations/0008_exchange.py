...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.impact_shares'
        db.add_column(u'project_project', 'impact_shares',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Project.exchange_periodicity'
        db.add_column(u'project_project', 'exchange_periodicity',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Project.exchange_magnitude'
        db.add_column(u'project_project', 'exchange_magnitude',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Project.date_last_exchange'
        db.add_column(u'project_project', 'date_last_exchange',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Project.impact_shares'
        db.delete_column(u'project_project', 'impact_shares')

        # Deleting field 'Project.exchange_periodicity'
        db.delete_column(u'project_project', 'exchange_periodicity')

        # Deleting field 'Project.exchange_magnitude'
        db.delete_column(u'project_project', 'exchange_magnitude')

        # Deleting field 'Project.date_last_exchange'
        db.delete_column(u'project_project', 'date_last_exchange')
