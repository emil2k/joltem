...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field subscriber_set on 'Project'
        m2m_table_name = db.shorten_name(u'project_project_subscriber_set')
    ...
    def backwards(self, orm):
        # Removing M2M table for field subscriber_set on 'Project'
        db.delete_table(db.shorten_name(u'project_project_subscriber_set'))
