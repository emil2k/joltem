...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Solution.title'
        db.add_column(u'solution_solution', 'title',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'solution_solution', 'application',
                      self.gf('django.db.models.fields.TextField')(default='s'),
                      keep_default=False)

        # Deleting field 'Solution.title'
        db.delete_column(u'solution_solution', 'title')
    ...
    models = {
        ...
        u'solution.votecomment': {
            'Meta': {'object_name': 'VoteComment'},
            'comment': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
