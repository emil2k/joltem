...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Solution.is_closed'
        db.add_column(u'solution_solution', 'is_closed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Solution.time_closed'
        db.add_column(u'solution_solution', 'time_closed',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Solution.is_closed'
        db.delete_column(u'solution_solution', 'is_closed')

        # Deleting field 'Solution.time_closed'
        db.delete_column(u'solution_solution', 'time_closed')
