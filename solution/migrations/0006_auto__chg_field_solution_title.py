...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Solution.title'
        db.alter_column(u'solution_solution', 'title', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Solution.title'
        db.alter_column(u'solution_solution', 'title', self.gf('django.db.models.fields.TextField')(null=True))
