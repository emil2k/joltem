...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Solution.is_archived'
        db.add_column(u'solution_solution', 'is_archived',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Solution.is_archived'
        db.delete_column(u'solution_solution', 'is_archived')
