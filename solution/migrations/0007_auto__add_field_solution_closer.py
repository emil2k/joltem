...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Solution.closer'
        db.add_column(u'solution_solution', 'closer',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['joltem.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Solution.closer'
        db.delete_column(u'solution_solution', 'closer_id')
