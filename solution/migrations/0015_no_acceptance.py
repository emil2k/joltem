...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Solution.is_accepted'
        db.delete_column(u'solution_solution', 'is_accepted')
    ...
    def backwards(self, orm):
        # Adding field 'Solution.is_accepted'
        db.add_column(u'solution_solution', 'is_accepted',
