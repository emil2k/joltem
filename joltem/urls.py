...
urlpatterns = patterns(
    ...
    url(r'^comment/(?P<comment_id>([0-9])+)/', login_required(views.comment), name='comment'),
    url(r'^notifications/(?P<notification_id>([0-9])+)/', login_required(views.NotificationRedirectView.as_view()), name='notification_redirect'),
