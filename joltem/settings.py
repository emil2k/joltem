# Django settings for joltem project.

DEBUG = True
TEMPLATE_DEBUG = DEBUG

ADMINS = (
    ('Emil', 'emil2k@gmail.com'),
)
...
DATABASES = {
    'default': {
        ...
        'NAME': 'joltem',                      # Or path to database file if using sqlite3.
        # The following settings are not used with sqlite3:
        'USER': 'jolt',
        'PASSWORD': 'chUtEVuf7stUJEnA',
...
SECRET_KEY = '8q=84ep+syuuv1r$42$+$r@d)wcu$+&x7gtp#i7+kz1wo+_!xw'
