...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Invite.personal_message'
        db.delete_column(u'joltem_invite', 'personal_message')

        # Adding field 'Invite.personal_note'
        db.add_column(u'joltem_invite', 'personal_note',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Invite.personal_message'
        db.add_column(u'joltem_invite', 'personal_message',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Deleting field 'Invite.personal_note'
        db.delete_column(u'joltem_invite', 'personal_note')
