...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Notification.notifying_kwargs'
        db.delete_column(u'joltem_notification', 'notifying_kwargs')

        # Adding field 'Notification.json_kwargs'
        db.add_column(u'joltem_notification', 'json_kwargs',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Notification.notifying_kwargs'
        db.add_column(u'joltem_notification', 'notifying_kwargs',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Notification.json_kwargs'
        db.delete_column(u'joltem_notification', 'json_kwargs')
