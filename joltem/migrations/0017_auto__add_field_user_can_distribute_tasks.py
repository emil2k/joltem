...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.can_distribute_tasks'
        db.add_column(u'joltem_user', 'can_distribute_tasks',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.can_distribute_tasks'
        db.delete_column(u'joltem_user', 'can_distribute_tasks')
