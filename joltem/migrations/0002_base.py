...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'joltem_repository', (
        ...
        db.send_create_signal(u'joltem', ['Repository'])

        # Adding model 'Permission'
        db.create_table(u'joltem_permission', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('branch', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['joltem.Branch'])),
        ))
        db.send_create_signal(u'joltem', ['Permission'])

        # Adding model 'Branch'
        db.create_table(u'joltem_branch', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('reference', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('repository', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['joltem.Repository'])),
            ('task_branch', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['joltem.TaskBranch'], null=True)),
        ))
        db.send_create_signal(u'joltem', ['Branch'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'joltem_repository')

        # Deleting model 'Permission'
        db.delete_table(u'joltem_permission')

        # Deleting model 'Branch'
        db.delete_table(u'joltem_branch')
    ...
    models = {
        ...
        u'joltem.branch': {
            ...
            'repository': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['joltem.Repository']"}),
            'task_branch': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['joltem.TaskBranch']", 'null': 'True'})
        },
        u'joltem.permission': {
            'Meta': {'object_name': 'Permission'},
            'branch': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['joltem.Branch']"}),
