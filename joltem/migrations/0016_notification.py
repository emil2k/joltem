...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.notifications'
        db.add_column(u'joltem_profile', 'notifications',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.notifications'
        db.delete_column(u'joltem_profile', 'notifications')
