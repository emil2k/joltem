...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Comment.time_updated'
        db.add_column(u'joltem_comment', 'time_updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=timezone.now, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comment.time_updated'
        db.delete_column(u'joltem_comment', 'time_updated')
