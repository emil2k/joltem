...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Notification.kwargs'
        db.add_column(u'joltem_notification', 'kwargs',
                      self.gf('jsonfield.fields.JSONField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Notification.kwargs'
        db.delete_column(u'joltem_notification', 'kwargs')
