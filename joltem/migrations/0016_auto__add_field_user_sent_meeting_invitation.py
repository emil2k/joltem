...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.sent_meeting_invitation'
        db.add_column(u'joltem_user', 'sent_meeting_invitation',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.sent_meeting_invitation'
        db.delete_column(u'joltem_user', 'sent_meeting_invitation')
