...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for user in orm['joltem.User'].objects.all():
            user.gravatar_email = user.profile.gravatar_email
            user.gravatar_hash = user.profile.gravatar_hash
            user.impact = user.profile.impact
            user.completed = user.profile.completed
            user.notifications = user.profile.notifications
            user.save()
