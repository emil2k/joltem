...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invite.is_contacted'
        db.add_column(u'joltem_invite', 'is_contacted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Invite.time_contacted'
        db.add_column(u'joltem_invite', 'time_contacted',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Invite.github'
        db.add_column(u'joltem_invite', 'github',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invite.is_contacted'
        db.delete_column(u'joltem_invite', 'is_contacted')

        # Deleting field 'Invite.time_contacted'
        db.delete_column(u'joltem_invite', 'time_contacted')

        # Deleting field 'Invite.github'
        db.delete_column(u'joltem_invite', 'github')
