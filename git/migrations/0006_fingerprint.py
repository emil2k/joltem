...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Authentication.fingerprint'
        db.add_column(u'git_authentication', 'fingerprint',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=47),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Authentication.fingerprint'
        db.delete_column(u'git_authentication', 'fingerprint')
