...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OAuth.username'
        db.add_column(u'account_oauth', 'username',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OAuth.username'
        db.delete_column(u'account_oauth', 'username')
    ...
    models = {
        u'account.oauth': {
            ...
            'username': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200'})
        },
        u'auth.group': {
