...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OAuth.username'
        db.alter_column(u'account_oauth', 'username', self.gf('django.db.models.fields.CharField')(max_length=200, null='True'))

    def backwards(self, orm):

        # Changing field 'OAuth.username'
        db.alter_column(u'account_oauth', 'username', self.gf('django.db.models.fields.CharField')(max_length=200))

    models = {
        u'account.oauth': {
            'Meta': {'object_name': 'OAuth'},
