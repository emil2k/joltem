...
urlpatterns = patterns(
    ...
    url(r'^open/my/$',
        login_required(views.MyOpenTasksView.as_view()), name='my_open'),
    url(r'^closed/my/$',
        login_required(views.MyClosedTasksView.as_view()), name='my_closed'),
    url(r'^review/$',
        login_required(views.MyReviewTasksView.as_view()), name='my_review'),
    url(r'^reviewed/my/$',
        login_required(views.MyReviewedTasksView.as_view()), name='my_reviewed'),
)
