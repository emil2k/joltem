...
urlpatterns = patterns(
    ...
    url(r'^review/my/$', login_required(views.MyReviewTasksView.as_view()), name='my_review'),
    url(r'^reviewed/my/$', login_required(views.MyReviewedTasksView.as_view()), name='my_reviewed'),
)